...
--
-- Host: localhost
-- Generation Time: Jan 16, 2017 at 11:07 PM
...
CREATE TABLE IF NOT EXISTS `examinees_info` (
  `id` int(15) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `exam_count` (
  `id` int(15) NOT NULL,
...
ALTER TABLE `examinees_info`
  ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `token_id` (`token_id`), ADD UNIQUE KEY `token_id_2` (`token_id`), ADD UNIQUE KEY `token_id_3` (`token_id`), ADD UNIQUE KEY `final_exam` (`token_id`), ADD KEY `token_id_4` (`token_id`), ADD KEY `exam_id` (`exam_id`);

--
-- Indexes for table `exam_count`
--
ALTER TABLE `exam_count`
  ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `exam_no_2` (`exam_no`), ADD KEY `exam_no` (`exam_no`);

--
-- Indexes for table `questions`
--
ALTER TABLE `questions`
  ADD PRIMARY KEY (`id`), ADD KEY `question_id` (`question_id`), ADD KEY `exam_no` (`exam_no`) USING BTREE;
...
--
ALTER TABLE `examinees_info`
  MODIFY `id` int(15) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=154;
--
