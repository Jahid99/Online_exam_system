...
if ($_SERVER['REQUEST_METHOD']=='POST') {
  ...
  if ($username == "" || $password == "") {
   ...
   $stmt = $db->link->prepare("SELECT * FROM teachers_info WHERE username=?");
...
<div class="container">
        ...
        <div class="row">
            <div class="box">
               ...
               <center>Don't have an account?<a href="teacher_registration.php">Register</a> here</center><br>

                <center>Forgot password?<a href="teacher_forgotpassword.php">Click here</a></center>
            </div>
